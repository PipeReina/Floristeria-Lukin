...
const validarFormulario = (e) => {
    switch (e.target.name){
        ...
        case "diasConvenio":
          ...
          break;
        case "salarioConvenio":
            if(expresiones.number.test(e.target.value)){
                document.getElementById('grupo_salarioConvenio').classList.remove('formulario_grupo-incorrecto');
                document.getElementById('grupo_salarioConvenio').classList.add('formulario_grupo-correcto');
                document.querySelector('#grupo_salarioConvenio i').classList.add('fa-check-circle');
                document.querySelector('#grupo_salarioConvenio i').classList.remove('fa-times-circle');
                document.querySelector('#grupo_salarioConvenio .formulario__input-error').classList.remove('formulario__input-error-activo');
                campos['apellido'] = true;
            }else{
                document.getElementById('grupo_salarioConvenio').classList.add('formulario_grupo-incorrecto')
                document.getElementById('grupo_salarioConvenio').classList.remove('formulario_grupo-correcto')
                document.querySelector('#grupo_salarioConvenio i').classList.add('fa-times-circle');
                document.querySelector('#grupo_salarioConvenio i').classList.remove('fa-check-circle');
                document.querySelector('#grupo_salarioConvenio .formulario__input-error').classList.add('formulario__input-error-activo');
                campos['apellido'] = false;
            }
          break;
